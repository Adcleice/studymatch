...
export default function UserProfile({session}){
  ...
  return <div style={s.page}>
    <header style={s.hero}>
      ...
      <button aria-label="Compartilhar perfil" style={s.shareProfile} onClick={()=>shareItem({title:`Perfil de ${p.name} no Matchworking`,text:`${p.username?'@'+p.username+' · ':''}Veja o perfil de ${p.name} no Matchworking.`,url:appUrl(`/user/${p.id}`)})}><Share2 size={17}/></button>
